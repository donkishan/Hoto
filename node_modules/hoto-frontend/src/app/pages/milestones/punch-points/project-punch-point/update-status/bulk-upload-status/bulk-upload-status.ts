 ...
 constructor(
  ...
  loadDataTable(): void {
    ...
    this.dataTable = $('#dataTable').DataTable({
      ...
      ajax: {
        url: `${this.baseUrl}/punch-points/status/upload-logs`,
        type: 'GET',
        data: (d:any) => {
  ...
  submitUpload(event: Event) {
    ...
    this.http.post<any>(`${this.baseUrl}/punch-points/upload-project-team-status`, formData, {
